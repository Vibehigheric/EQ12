...
<head>
    ...
    <style>
        ...
        .container { max-width: 1200px; margin: 0 auto; background: white; border-radius: 15px; padding: 30px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); }
...
try {
    ...
    switch ($Action) {
        ...
        "QuickCheck" {
            ...
            if ($InjuryReport) {
                Write-Host "`nQuick Intelligence Summary:" -ForegroundColor Cyan
        ...
        "FullReport" {
            ...
            if ($InjuryReport -and $GenerateReport) {
                ...
                Write-Host "`nFull HTML report generated: $ReportFile" -ForegroundColor Green
...
Write-Host "`nNFL Intelligence Wrapper execution completed!" -ForegroundColor Green