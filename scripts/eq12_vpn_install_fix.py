...
def print_installation_fix_guide():
    ...
    print("\n🛠️ SOLUTION 1: ADMINISTRATOR INSTALLATION")
    ...
    print("\n🛠️ SOLUTION 2: CLEAN TEMP FILES & RETRY")
    ...
    print("\n🛠️ SOLUTION 3: WINDOWS INSTALLER REPAIR")
