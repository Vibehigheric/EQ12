...
Write-Host " Partial: $PartialSystems/5 USB systems" -ForegroundColor Yellow
...
if (Test-Path $ConfigFile) {
    ...
    try {
        ...
        Write-Host " Configuration file found but invalid JSON" -ForegroundColor Yellow
    }
} else {
