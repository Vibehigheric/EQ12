...
function Start-MonitoringSession {
    ...
    try {
        ...
        Write-EQ12Log " Duration: $Duration hours"
    ...
    if ($success) {
        ...
        if ($trendFiles) {
            ...
            try {
                ...
                Write-EQ12Log " Could not parse trend data: $_" "WARN"
            }
        }
    }
