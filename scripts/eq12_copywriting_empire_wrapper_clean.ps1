...
try {
    ...
    switch ($Action) {
        ...
        "FullEmpire" {
            ...
            if ($success) {
                Invoke-DeploymentPhases -Workspace $Workspace
                Write-EQ12Log " Empire deployment completed with 14+ active streams" "SUCCESS"
            }
        }
        "QuickLaunch" {
    ...
    if ($GenerateReport) {
        ...
        $reportData = @{
            ...
            "Total_Monthly_Target" = 740000
            "Total_Annual_Projection" = 8880000
            "Active_Streams" = 14
            "Automation_Score" = "72.5%"
            "Market_Domination" = "64.7%"
        }
