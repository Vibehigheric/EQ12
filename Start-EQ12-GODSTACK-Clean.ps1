...
.DESCRIPTION
PowerShell wrapper for the EQ12 System Manager
#>

$ErrorActionPreference = "Stop"

# EQ12 GODSTACK Banner
Write-Host "=====================================================" -ForegroundColor Cyan
Write-Host "                  EQ12 GODSTACK                     " -ForegroundColor Cyan
Write-Host "              COMPLETE SYSTEM STARTUP               " -ForegroundColor Cyan
Write-Host "=====================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Expert Kelly Integration System" -ForegroundColor Green
Write-Host "Paper Trading Module" -ForegroundColor Green
Write-Host "Historical Backtesting Engine" -ForegroundColor Green
Write-Host "EdgeGod Parlay System" -ForegroundColor Green
Write-Host "Browser Governance Automation" -ForegroundColor Green
Write-Host "AI Governance Suite" -ForegroundColor Green
Write-Host ""
Write-Host "Ready for automated sports betting optimization!" -ForegroundColor Yellow
Write-Host "=====================================================" -ForegroundColor Cyan
...
try {
    ...
    Write-Host ""
    Write-Host "Execution completed in $($Duration.TotalSeconds.ToString('F1')) seconds" -ForegroundColor Yellow
    ...
    if ($ExitCode -eq 0) {
        ...
        if (!$Status -and !$RestartComponent) {
            ...
            if ($SkipBrowser) {
                Write-Host "   Browser Automation: Skipped"
            } else {
                Write-Host "   Browser Automation: Ready"
            }
            if ($SkipAI) {
                Write-Host "   AI Governance: Skipped"
            } else {
                Write-Host "   AI Governance: Active"
            }
...
if ($ExitCode -eq 0 -and !$Status -and !$RestartComponent -and !$TestMode) {
    Write-Host ""
    Write-Host "PowerShell Integration Available:" -ForegroundColor Magenta
