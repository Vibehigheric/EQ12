...
if events_response.status_code != 200:
    print(
        f"Failed to get sports: status_code {events_response.status_code}, response body {events_response.text}"
    )
    exit()
...
odds_response = requests.get(
    f"https://api.the-odds-api.com/v4/sports/{SPORT}/events/{first_event_id}/odds",
    params={
        "api_key": API_KEY,
        "regions": REGIONS,
        "markets": MARKETS,
