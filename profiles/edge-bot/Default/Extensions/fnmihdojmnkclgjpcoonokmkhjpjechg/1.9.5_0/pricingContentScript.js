...
(function() {
    ...
    function hasPopupBeenShown() {
        try {
            return sessionStorage.getItem('aitopia-popup-shown') === 'true';
        } catch (error) {
            console.log('SessionStorage not available, popup will show');
            return false;
        }
    }
    ...
    function markPopupAsShown() {
        try {
            sessionStorage.setItem('aitopia-popup-shown', 'true');
        } catch (error) {
            console.log('Could not save popup state to sessionStorage');
        }
    }
