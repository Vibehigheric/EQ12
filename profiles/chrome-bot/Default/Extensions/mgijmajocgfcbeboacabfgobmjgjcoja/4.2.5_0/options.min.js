...
1;g++){var e=a[g];if(!(e in d))break a;d=d[e]}a=a[a.length-1];g=d[a];b=b(g);b!=g&&b!=null&&p(d,a,{configurable:!0,writable:!0,value:b})}},u=function(a){var b=0;return function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}}},v=function(a){var b=typeof Symbol!="undefined"&&Symbol.iterator&&a[Symbol.iterator];if(b)return b.call(a);if(typeof a.length=="number")return{next:u(a)};throw Error(String(a)+" is not an iterable or ArrayLike");},w=function(){this.u=!1;this.j=null;this.G=void 0;this.h=1;
this.J=this.P=0;this.o=null},x=function(a){if(a.u)throw new TypeError("Generator is already running");a.u=!0};w.prototype.v=function(a){this.G=a};w.prototype.B=function(a){this.o={R:a,U:!0};this.h=this.P||this.J};w.prototype.return=function(a){this.o={return:a};this.h=this.J};var y=function(a,b,d){a.h=d;return{value:b}},z=function(a){this.g=new w;this.W=a};z.prototype.v=function(a){x(this.g);if(this.g.j)return A(this,this.g.j.next,a,this.g.v);this.g.v(a);return B(this)};
var ba=function(a,b){x(a.g);var d=a.g.j;if(d)return A(a,"return"in d?d["return"]:function(g){return{value:g,done:!0}},b,a.g.return);a.g.return(b);return B(a)};z.prototype.B=function(a){x(this.g);if(this.g.j)return A(this,this.g.j["throw"],a,this.g.v);this.g.B(a);return B(this)};
var A=function(a,b,d,g){try{var e=b.call(a.g.j,d);if(!(e instanceof Object))throw new TypeError("Iterator result "+e+" is not an object");if(!e.done)return a.g.u=!1,e;var l=e.value}catch(c){return a.g.j=null,a.g.B(c),B(a)}a.g.j=null;g.call(a.g,l);return B(a)},B=function(a){for(;a.g.h;)try{var b=a.W(a.g);if(b)return a.g.u=!1,{value:b.value,done:!1}}catch(d){a.g.G=void 0,a.g.B(d)}a.g.u=!1;if(a.g.o){b=a.g.o;a.g.o=null;if(b.U)throw b.R;return{value:b.return,done:!0}}return{value:void 0,done:!0}},C=function(a){this.next=
function(b){return a.v(b)};this.throw=function(b){return a.B(b)};this.return=function(b){return ba(a,b)};this[Symbol.iterator]=function(){return this}},D=function(a){function b(g){return a.next(g)}function d(g){return a.throw(g)}return new Promise(function(g,e){function l(c){c.done?g(c.value):Promise.resolve(c.value).then(b,d).then(l,e)}l(a.next())})};
t("Symbol",function(a){if(a)return a;var b=function(l,c){this.N=l;p(this,"description",{configurable:!0,writable:!0,value:c})};b.prototype.toString=function(){return this.N};var d="jscomp_symbol_"+(Math.random()*1E9>>>0)+"_",g=0,e=function(l){if(this instanceof e)throw new TypeError("Symbol is not a constructor");return new b(d+(l||"")+"_"+g++,l)};return e});
...
t("Promise",function(a){function b(){this.i=null}function d(c){return c instanceof e?c:new e(function(f){f(c)})}if(a)return a;b.prototype.H=function(c){if(this.i==null){this.i=[];var f=this;this.I(function(){f.S()})}this.i.push(c)};var g=r.setTimeout;b.prototype.I=function(c){g(c,0)};b.prototype.S=function(){for(;this.i&&this.i.length;){var c=this.i;this.i=[];for(var f=0;f<c.length;++f){var h=c[f];c[f]=null;try{h()}catch(k){this.O(k)}}}this.i=null};b.prototype.O=function(c){this.I(function(){throw c;
})};var e=function(c){this.m=0;this.A=void 0;this.l=[];this.L=!1;var f=this.D();try{c(f.resolve,f.reject)}catch(h){f.reject(h)}};e.prototype.D=function(){function c(k){return function(m){h||(h=!0,k.call(f,m))}}var f=this,h=!1;return{resolve:c(this.Y),reject:c(this.F)}};e.prototype.Y=function(c){if(c===this)this.F(new TypeError("A Promise cannot resolve to itself"));else if(c instanceof e)this.aa(c);else{a:switch(typeof c){case "object":var f=c!=null;break a;case "function":f=!0;break a;default:f=
!1}f?this.X(c):this.K(c)}};e.prototype.X=function(c){var f=void 0;try{f=c.then}catch(h){this.F(h);return}typeof f=="function"?this.ba(f,c):this.K(c)};e.prototype.F=function(c){this.M(2,c)};e.prototype.K=function(c){this.M(1,c)};e.prototype.M=function(c,f){if(this.m!=0)throw Error("Cannot settle("+c+", "+f+"): Promise already settled in state"+this.m);this.m=c;this.A=f;this.m===2&&this.Z();this.T()};e.prototype.Z=function(){var c=this;g(function(){if(c.V()){var f=r.console;typeof f!=="undefined"&&
f.error(c.A)}},1)};e.prototype.V=function(){if(this.L)return!1;var c=r.CustomEvent,f=r.Event,h=r.dispatchEvent;if(typeof h==="undefined")return!0;typeof c==="function"?c=new c("unhandledrejection",{cancelable:!0}):typeof f==="function"?c=new f("unhandledrejection",{cancelable:!0}):(c=r.document.createEvent("CustomEvent"),c.initCustomEvent("unhandledrejection",!1,!0,c));c.promise=this;c.reason=this.A;return h(c)};e.prototype.T=function(){if(this.l!=null){for(var c=0;c<this.l.length;++c)l.H(this.l[c]);
this.l=null}};var l=new b;e.prototype.aa=function(c){var f=this.D();c.C(f.resolve,f.reject)};e.prototype.ba=function(c,f){var h=this.D();try{c.call(f,h.resolve,h.reject)}catch(k){h.reject(k)}};e.prototype.then=function(c,f){function h(n,q){return typeof n=="function"?function(K){try{k(n(K))}catch(L){m(L)}}:q}var k,m,M=new e(function(n,q){k=n;m=q});this.C(h(c,k),h(f,m));return M};e.prototype.catch=function(c){return this.then(void 0,c)};e.prototype.C=function(c,f){function h(){switch(k.m){case 1:c(k.A);
break;case 2:f(k.A);break;default:throw Error("Unexpected state: "+k.m);}}var k=this;this.l==null?l.H(h):this.l.push(h);this.L=!0};e.resolve=d;e.reject=function(c){return new e(function(f,h){h(c)})};e.race=function(c){return new e(function(f,h){for(var k=v(c),m=k.next();!m.done;m=k.next())d(m.value).C(f,h)})};e.all=function(c){var f=v(c),h=f.next();return h.done?d([]):new e(function(k,m){function M(K){return function(L){n[K]=L;q--;q==0&&k(n)}}var n=[],q=0;do n.push(void 0),q++,d(h.value).C(M(n.length-
1),m),h=f.next();while(!h.done)})};return e});var da=function(a,b){a instanceof String&&(a+="");var d=0,g=!1,e={next:function(){if(!g&&d<a.length){var l=d++;return{value:b(l,a[l]),done:!1}}g=!0;return{done:!0,value:void 0}}};e[Symbol.iterator]=function(){return e};return e};t("Array.prototype.keys",function(a){return a?a:function(){return da(this,function(b){return b})}});var E,F,G,H,I,J,N,O,P,Q,R,S,T,ea,U,V,W,fa=function(){var a,b;return D(new C(new z(function(d){if(d.h==1)return a={},a.language=G.options[G.selectedIndex].value,a.popupDblclick=H.checked?"true":"false",a.popupSelect=N.checked?"true":"false",a.popupDblclickKey=J.options[J.selectedIndex].value,a.popupSelectKey=P.options[P.selectedIndex].value,a.storeHistory=Q.checked?"true":"false",a.allowCrossExtensionHistory=T.checked?"true":"false",a.enableHttps="true",y(d,chrome.storage.local.set({options:a}),2);
...
2;break}a="options"in window.localStorage?JSON.parse(window.localStorage.options):void 0;b={};return y(g,chrome.storage.local.set((b["storage-migrated"]=!0,b.options=a,b)),3);case 3:window.close();case 2:return X(!1),y(g,ha(),4);case 4:d=g.G,Y(G,d.language),H.checked=d.popupDblclick==="true",ia(),N.checked=d.popupSelect==="true",ja(),Y(J,d.popupDblclickKey),Y(P,d.popupSelectKey),Q.checked=d.storeHistory==="true",T.checked=d.allowCrossExtensionHistory==="true",ka(),chrome.storage.local.get("word-history",
